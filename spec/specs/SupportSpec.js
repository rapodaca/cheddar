...
describe("Support", function() {
  ...
  describe("#bytesToSHA256", function() {
    //http://www.nsrl.nist.gov/testdata/
    it("returns expected value given empty byte array", function() {
      expect(Support.bytesToSHA256([])).toEqual([
    ...
    it("returns expected value given 'abc' byte array", function() {
      expect(Support.bytesToSHA256([0x61, 0x62, 0x63])).toEqual([
    ...
    it("returns expected value given 'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq' byte array", function() {
      ...
      expect(Support.bytesToSHA256(bytes)).toEqual([
  ...
  describe("#bytesToBase58", function() {
    ...
    it("returns expected result from libbitcoin", function() {
      ...
      expect(Support.bytesToBase58(bytes)).toEqual('19TbMSWwHvnxAKy12iNm3KdbGfzfaMFViT');
    });
  });
  // Test vectors from:
  // http://homes.esat.kuleuven.be/~bosselae/ripemd160.html
  describe("#bytesToRIPEMD160", function() {
    it("returns hash given ''", function() {
      expect(Support.bytesToRIPEMD160([ ])).toEqual([
    ...
    it("returns hash given 'a'", function() {
      ...
      expect(Support.bytesToRIPEMD160(bytes)).toEqual([
  ...
  /**
   * Test vectors: http://tools.ietf.org/search/rfc4231#section-4.2
   */
  describe("#hmacSHA512", function() {
    it("returns correct bytes given Test Case 1", function() {
      var key = [
      ...
      expect(Support.hmacSHA512(key, message)).toEqual([
    ...
    it("returns correct bytes given Test Case 2", function() {
      var key = [ 74, 101, 102, 101 ];
      var message = [
